...
function Hero() {
    return ( 
        <div className="container ">
            <div className="row border-bottom p-5 mt-4 text-center ">
            ...
            <div className="row p-5 mt-3 text-center">
                <div className="col-4 p-5">
                    ...
                    <h1 className='fs-4 mb-2'>Free equity delivery</h1>
                ...
                <div className="col-4 p-5">
                    ...
                    <h1 className='fs-4 mb-2'>Intraday and F&O trades</h1>
                ...
                <div className="col-4 p-5 ">
                    <img src="media/images/pricingEquity.svg" alt="" />
                    <h1 className='fs-4 mb-2'>Free direct MF</h1>
