    ...
    return ( 
        <div className="container">
            <div className="row p-5 mt-3 mb-5">
                ...
                <div className="col-4">
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-user"></i> Your Zerodha Account</h4>
                ...
                <div className="col-4">
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-chart-simple"></i> Your Zerodha Account</h4>
