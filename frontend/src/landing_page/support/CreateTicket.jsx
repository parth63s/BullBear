        ...
        <div className="container">
            <div className="row p-5 mt-3 mb-5">
                ...
                <div className="col-4">
                    ...
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Charges at BullBear</a><br />
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>BullBear IDFC FIRST Bank 3-in-1 Account</a><br />
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Getting Started</a><br />
                </div>
                <div className="col-4">
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-user"></i> Your BullBear Account</h4>
                    
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Login Credentials</a><br />
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Account Modification and Segment Addtion</a><br />
                ...
                <div className="col-4">
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-chart-simple"></i> Your BullBear Account</h4>
                ...
                {/* <div className="col-4">
                    <h4 className='fs-5 mb-4 mt-5'> <i class="fa-regular fa-credit-card"></i> Funds</h4>
                ...
                <div className="col-4">
                    <h4 className='fs-5 mb-4 mt-5'><i class="fa-solid fa-c"></i> Console</h4>
                ...
                <div className="col-4">
                    <h4 className='fs-5 mb-4 mt-5'><i class="fa-regular fa-circle"></i> Coin</h4>
